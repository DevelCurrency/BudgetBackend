# Generated by Django 3.2.4 on 2021-08-04 08:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('startdate', models.DateTimeField(default=datetime.datetime.now, verbose_name='Дата начала действия записи')),
                ('enddate', models.DateTimeField(blank=True, default=None, null=True, verbose_name='Дата окончания действия записи')),
                ('budgetname', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='Budget.budget', verbose_name='Бюджет')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('startdate', models.DateTimeField(default=datetime.datetime.now, verbose_name='Дата начала действия записи')),
                ('enddate', models.DateTimeField(blank=True, default=None, null=True, verbose_name='Дата окончания действия записи')),
                ('ppocode', models.CharField(blank=True, max_length=8, null=True, verbose_name='ППО Код')),
                ('budgetname', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='Budget.budget', verbose_name='Бюджет')),
            ],
            options={
                'verbose_name': 'Справочник главы по бюджетной классификации',
